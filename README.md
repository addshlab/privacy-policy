...
## クッキー(Cookie)の取り扱いについて

当ウェブサイトでは以下の目的のため、クッキーを使用しています。

1. Gooble Analytics により当ウェブサイトのアクセス状況を分析し、当サービスを改善するため。
1. Google などの第三者配信事業者が Cookie を使用して、ユーザーがそのウェブサイトや他のウェブサイトに過去にアクセスした際の情報に基づいて広告を配信するため
1. Google が広告 Cookie を使用することにより、ユーザーがそのサイトや他のサイトにアクセスした際の情報に基づいて、Google やそのパートナーが適切な広告をユーザーに表示するため

以下のサイトにアクセスすれば、パーソナライズ広告および第三者配信事業者によるクッキーの使用を無効化することが可能です。

* https://www.google.com/settings/ads/anonymous
* http://www.aboutads.info/choices/

クッキーを使用することで当ウェブサイトはお客様のコンピュータを識別できるようになりますが、お客様個人を特定できるものではありません。

ブラウザの設定によりクッキーの受け取りを拒否することができますが、当ウェブサイトが提供するサービスを一部利用できなくなる場合があります。

## 著作権・肖像権

* 当ウェブサイトの文章や画像について、それが当方の許諾や併記されたライセンスで認められている場合を除き、無断転載を禁止します。
* 当ウェブサイトの文章や画像について、細心の注意を払って作成しておりますが、第三者の著作権や肖像権を侵害している可能性がある場合は、権利者からの連絡に応じて速やかに対応いたします。
