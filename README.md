...
※以下URLより、第三者配信事業者によるクッキーの使用を無効化することが可能です。

* https://www.google.com/settings/ads/anonymous

また、当ウェブサイトの広告の配信時に第三者配信事業者や広告ネットワークの Cookie が使用される可能性があります。

クッキーを使用することで当ウェブサイトはお客様のコンピュータを識別できるようになりますが、お客様個人を特定できるものではありません。

また、ブラウザの設定によりクッキーの受け取りを拒否することができますが、当ウェブサイトが提供するサービスを一部利用できなくなる場合があります。
